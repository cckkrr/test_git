...
public class TypeConversion {
     ...
     * @return
     */
    public static String hexString2DecString(String src) {
        String temp = "";
        for (int i = 0; i < src.length() / 2; i++) {
            Integer value = Integer.valueOf(src.substring(i * 2, i * 2 + 2),
                    16);
            if(value < 10){
                temp = temp + "0"+ value;
            }else{
     ...
     * @return
     */
    public static String onehexString2DecString(String src) {
        String temp = "";
        for (int i = 0; i < src.length(); i++) {
            Integer value = Integer.valueOf(src, 16);
            if(value < 10){
                temp = temp + "0"+ value;
            }else{
                temp = temp+value;
